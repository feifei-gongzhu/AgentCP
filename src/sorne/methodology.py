...
WEB_PACK = MethodPack("sorne-web-v3", "Web 渗透 Method Pack", "web", "0.0.3", WEB_DIMENSIONS)
CLIENT_PACK = MethodPack("sorne-client-v3", "客户端漏洞挖掘 Method Pack", "client", "0.0.3", CLIENT_DIMENSIONS)
